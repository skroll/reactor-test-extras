...
public abstract class BaseTestConsumer<T, U extends BaseTestConsumer<T, U>> implements Disposable {
  ...
  /** The last thread seen by the consumer. */
   ...
   */
  @SuppressWarnings("unchecked")
  public final U assertError(final Predicate<Throwable> errorPredicate) {
    int s = errors.size();
    if (s == 0) {
   ...
   */
  @SuppressWarnings("unchecked")
  public final U assertValue(final T value) {
    int s = values.size();
    if (s != 1) {
   ...
   */
  @SuppressWarnings("unchecked")
  public final U assertValue(final Predicate<T> valuePredicate) {
   ...
   */
  @SuppressWarnings("unchecked")
  public final U assertValueAt(final int index, final Predicate<T> valuePredicate) {
    int s = values.size();
    if (s == 0) {
      throw fail("No values");
    }
